...
from ubuntutweak0.ui.dialogs import *
from ubuntutweak0.modules  import TweakModule
from ubuntutweak0.modules.sourcecenter import refresh_source
...
#        set_label_for_stock_button(self.submit_button, _('Submit Sources'))
    ...
    def notify_sourcecenter(self):
        self.emit('call', 'ubuntutweak0.modules.sourcecenter', 'update_thirdparty', {})
