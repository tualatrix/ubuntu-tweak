...
from ubuntutweak0.policykit import PolkitButton, proxy
from ubuntutweak0.ui import GconfCheckButton
from ubuntutweak0.ui.dialogs import QuestionDialog, ErrorDialog, InfoDialog, WarningDialog
from ubuntutweak0.ui.dialogs import ServerErrorDialog, AuthenticateFailDialog
from ubuntutweak0.utils.parser import Parser
from ubuntutweak0.network import utdata
...
from ubuntutweak0.utils import set_label_for_stock_button
from ubuntutweak0.utils import ppa
from ubuntutweak0.common import consts
from ubuntutweak0.common.config import Config, TweakSettings
from ubuntutweak0.common.package import PACKAGE_WORKER, PackageInfo
from ubuntutweak0.common.notify import notify
from ubuntutweak0.common.misc import URLLister
...
class SourcesView(gtk.TreeView):
    ...
    def setup_ubuntu_cn_mirror(self):
        ...
        if UNCONVERT:
            import ubuntutweak0.common.sourcedata
            reload(ubuntutweak0.common.sourcedata)
            global SOURCES_DATA
            from ubuntutweak0.common.sourcedata import SOURCES_DATA
...
#                                       self.value_changed)
    ...
    def upgrade_sources(self):
        ...
        if response == gtk.RESPONSE_YES:
            ...
            self.emit('call', 'ubuntutweak0.modules.sourceeditor', 'update_source_combo', {})
...
#                    self.sourceview.setup_ubuntu_cn_mirror()
    ...
    def on_update_button_clicked(self, widget):
        ...
        self.emit('call', 'ubuntutweak0.modules.appcenter', 'update_app_data', {})
        self.emit('call', 'ubuntutweak0.modules.updatemanager', 'update_list', {})
