...
class LockdownPage(gtk.VBox):
        """Lock down some function"""

        __key_lockdown_dir = "/desktop/gnome/lockdown"
		...
		for key in lockdown_keys:
			button = GConfCheckButton(lockdown_names[lockdown_keys.index(key)], key, self.__key_lockdown_dir)
