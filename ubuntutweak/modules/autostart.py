...
class AutoStartDialog(Gtk.Dialog):
    ...
    def __init__(self, desktopentry = None, parent = None):
        ...
        hbox.pack_start(self.pm_cmd, True, True, 0)
        hbox.pack_start(button, False, False, 0)

        table = Gtk.Table(3, 2)
        table.attach(lbl1, 0, 1, 0, 1, xoptions = Gtk.AttachOptions.FILL, xpadding = 10, ypadding = 10)
        table.attach(lbl2, 0, 1, 1, 2, xoptions = Gtk.AttachOptions.FILL, xpadding = 10, ypadding = 10)
        table.attach(lbl3, 0, 1, 2, 3, xoptions = Gtk.AttachOptions.FILL, xpadding = 10, ypadding = 10)
        table.attach(self.pm_name, 1, 2, 0, 1)
        table.attach(hbox, 1, 2, 1, 2, yoptions = Gtk.AttachOptions.EXPAND)
...
class AutoStartItem(Gtk.TreeView):
    ...
    def __init__(self):
        ...
        model.set_sort_column_id(COLUMN_PROGRAM, Gtk.SortType.ASCENDING)
