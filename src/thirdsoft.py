...
ChromiumBrowser = ['Chromium Browser', 'chromium-browser', 'https://launchpad.net/chromium-project', 'chromium-browser.gpg']
...
SOURCES_DATA = [
    ...
    ['http://ppa.launchpad.net/ubuntu-tweak-testing/ppa/ubuntu', ['hardy', 'intrepid'], 'main', UbuntuTweakTesting],
